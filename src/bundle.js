...
var _helloWorld = require("./components/hello-world/hello-world");

var _helloWorld2 = _interopRequireDefault(_helloWorld);

var _discountWidget = require("./components/discount-widget/discount-widget");

var _discountWidget2 = _interopRequireDefault(_discountWidget);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_knockout2.default.components.register("hello-world", _helloWorld2.default); // var ko = require("knockout");

// ko.components.register("discount-widget", require("./components/discount-widget/discount-widget.js"));

// ko.applyBindings();

_knockout2.default.components.register("discount-widget", _discountWidget2.default);

_knockout2.default.applyBindings();

},{"./components/discount-widget/discount-widget":4,"./components/hello-world/hello-world":6,"knockout":1}],3:[function(require,module,exports){
...
var _discountWidget = require("./discount-widget.html");
...
var DiscountWidget = (function () {
	function DiscountWidget(params) {
		_classCallCheck(this, DiscountWidget);

		this.logo = _knockout2.default.observable(params.logo);
		this.netPrice = _knockout2.default.observable();
		this.discountPercent = _knockout2.default.observable();
		this.result = _knockout2.default.observable();
	}

	_createClass(DiscountWidget, [{
		key: "calculate",
...
exports.default = {
	...
	template: _discountWidget2.default
};

},{"./discount-widget.html":3,"knockout":1}],5:[function(require,module,exports){
...
var _helloWorld = require("./hello-world.html");
...
exports.default = {
	...
	template: _helloWorld2.default
};

},{"./hello-world.html":5,"knockout":1}]},{},[2])